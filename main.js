...
function receiveUpdatedStates(x3dWorld, aircraft, websocket) {
...
function sendUserInputs(aircraft) {
  ...
  ws.send(JSON.stringify({"axisX": aircraft.axisX, "axisY": aircraft.axisY, "axisZ": aircraft.axisZ, "theta": aircraft.theta, "bodyX": aircraft.bodyX, "bodyY": aircraft.bodyY }));
}

document.addEventListener("DOMContentLoaded", () => {
  ws.onopen = () => {
    console.log("WebSocket connected.");
    receiveUpdatedStates(x3dWorld, aircraft, ws);
